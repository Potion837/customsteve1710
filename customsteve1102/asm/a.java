...
implements d {
    ...
    public byte[] a(boolean isConfusion, String arg0, e names, byte[] bytes) {
        ...
        this.a = names.a(isConfusion, "EntityPlayer");
        while (methods.hasNext()) {
            MethodNode m2 = (MethodNode)methods.next();
            if (!names.a("EntityPlayer.addMovementStat").a(m2.name) || !m2.desc.equals("(DDD)V")) continue;
            InsnList inject = new InsnList();
            inject.add((AbstractInsnNode)new VarInsnNode(25, 0));
            inject.add((AbstractInsnNode)new MethodInsnNode(184, ASMPointer.class.getName().replace(".", "/"), "f", "(L" + this.a + ";)V"));
